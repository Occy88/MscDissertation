...
\begin{figure}[h]
 ...
 \includegraphics[width=0.7\textwidth]{Core Architecture.PNG}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.3\textwidth]{parser_dir}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1\textwidth]{learning_module_interaction_uml.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1\textwidth]{final_integration_uml.png}
...
\begin{figure}[h]
 ...
 \includegraphics[width=1\textwidth]{movegraph_100.png}
 ...
 \includegraphics[width=1\textwidth]{movegraph_100_cum.png}
...
\begin{figure}[h]
 \centering
 \begin{minipage}[b]{0.49\linewidth}
 \includegraphics[width=1\textwidth]{movegraph_rand_70.png}
 ...
 \includegraphics[width=1\textwidth]{movegraph_rand_30.png}
...
\begin{figure}[h]
 \centering
 \begin{minipage}[b]{0.49\linewidth}
 \includegraphics[width=1\textwidth]{movegraph_sys_70.png}
 ...
 \includegraphics[width=1\textwidth]{movegraph_sys_30.png}
