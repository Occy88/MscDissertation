...
\begin{figure}[h]
\centering
 \includegraphics[width=\linewidth]{images/git-flow}
...
\begin{figure}[h]
\centering
 \includegraphics[width=1\linewidth]{images/parser_uml}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.7\linewidth]{images/data_generator_uml}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.7\linewidth]{images/learning_model_uml}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.7\linewidth]{images/action_model_reconstructor_uml}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.4\linewidth]{images/domain_simulator}
 \caption{Basic action model reconstructor implementation UML.}
